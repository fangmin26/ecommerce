...
export class AuthController {
  ...
  @ApiOperation({
    summary: '로그인 - email,username,password',
    description: '이메일 로그인',
  })
  @Throttle(2, 60)
  ...
  @ApiOperation({
    summary: 'bootpay 본인인증',
    description: 'bootpay 본인인증',
  })
  ...
  @ApiOperation({
    summary: 'bootpay 본인인증 확인',
    description: 'bootpay 본인인증 확인',
  })
  ...
  @ApiOperation({
    ...
    description:
      'email 로 토큰(이메일과 다른) 링크 확인 후 changePasswordByEmail로 password change',
  })
  ...
  @ApiOperation({
    summary: 'password changeby email',
  ...
  @Get('refresh')
  @ApiOperation({
    summary: 'refresh token in cookies',
